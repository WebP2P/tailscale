...
func TestDeps(t *testing.T) {
	deptest.DepChecker{
		...
		BadDeps: map[string]string{
			...
			"github.com/WebP2P/dexnet/net/wsconn":            "https://github.com/tailscale/tailscale/issues/13762",
			...
			"github.com/WebP2P/dexnet/clientupdate/distsign": "downloads via AppStore, not distsign",
			"github.com/tailscale/hujson":         "no config file support on iOS",
			"github.com/WebP2P/dexnet/feature/capture":       "no debug packet capture on iOS",
		},
	}.Check(t)
}
