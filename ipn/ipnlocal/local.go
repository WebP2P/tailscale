...
import (
	...
	"github.com/WebP2P/dexnet/envknob/featureknob"
	...
	"github.com/WebP2P/dexnet/log/sockstatlog"
	...
	"github.com/WebP2P/dexnet/net/ipset"
	"github.com/WebP2P/dexnet/net/netcheck"
	"github.com/WebP2P/dexnet/net/netkernelconf"
	...
	"github.com/WebP2P/dexnet/util/checkchange"
	...
	"github.com/WebP2P/dexnet/wgengine/magicsock"
...
func (b *LocalBackend) reconfigAppConnectorLocked(nm *netmap.NetworkMap, prefs ipn.PrefsView) {
	...
	const appConnectorCapName = "github.com/WebP2P/dexnet/app-connectors"
	defer func() {
		if b.hostinfo != nil {
