...
func autoflagsForTest(argv []string, env *Environment, goroot, nativeGOOS, nativeGOARCH string, getVersion func() mkversion.VersionInfo) (newArgv []string, newEnv *Environment, err error) {
	...
	vi := getVersion()
	ldflags = []string{
		"-X", "github.com/WebP2P/dexnet/version.longStamp=" + vi.Long,
		"-X", "github.com/WebP2P/dexnet/version.shortStamp=" + vi.Short,
		"-X", "github.com/WebP2P/dexnet/version.gitCommitStamp=" + vi.GitHash,
		"-X", "github.com/WebP2P/dexnet/version.extraGitCommitStamp=" + vi.OtherHash,
	}
